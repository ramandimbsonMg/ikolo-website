...
export const ContactView = () => {
  ...
  return (
    <>
      <Container className="mt-4 lg:container lg:mx-auto relative px-6 space-y-2 lg:pt-20 h-screen">
        ...
        <div className="lg:pt-6 lg:grid grid-cols-1 lg:grid-cols-2 lg:gap-6 space-y-4 lg:space-y-0 lg:items-center">
          <div className="space-y-4">
            <Typography variant="xlarge" theme="black" className="pb-6">
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="flex items-center gap-2 group">
                ...
                <div>
                  ...
                  >
                    Madagascar - Antananarivo - Sabotsy Namehana
                  </Typography>
                </div>
              </div>
              <div className="flex items-center gap-2 group">
                ...
                >
                  ...
                  <Typography variant="medium">+261 38 90 524 67</Typography>
                </Link>
              </div>
              ...
              <div className="flex items-center gap-2 group">
                ...
                <div>
                  ...
                  >
                    <a
                      href="mailto:ramandimbsonespoir@gmail.com"
                      className="text-[14px]"
                    >
              ...
              <div className="flex items-center gap-2 group">
                ...
                <div>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="hover:text-primary hover:underline text-[14px]"
                  >
                    +261 38 90 524 67
                  </a>
                </div>
